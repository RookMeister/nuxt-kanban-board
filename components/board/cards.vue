  ...
  <div class="list-cards">
    <draggable v-model="cards" :options="{ draggable: '.list-card', group: 'card' }" style="min-height:2px;height:100%;">
      <div class="list-card" v-for="(card, i) in cards" :key="i">
        <v-textarea class="pa-0" full-width hide-details auto-grow rows="1" row-height="5" v-model="card.name" style="font-size: 20px;line-height: 24px;" @blur="updateCard(card)"></v-textarea>
        <v-spacer></v-spacer>
